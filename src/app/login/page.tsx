            ...
            <div className="max-w-md w-full bg-white dark:bg-zinc-900/60 rounded-3xl shadow-2xl p-8 border border-border/50 dark:border-zinc-800 relative z-10 backdrop-blur-xl">
                <div className="text-center mb-8">
                    ...
                    <div className="flex justify-center mt-4">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 dark:bg-primary/5 border border-primary/20 dark:border-primary/10 backdrop-blur-sm">
                            <div className="flex -space-x-1.5">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="w-5 h-5 rounded-full border-2 border-white dark:border-zinc-900 bg-primary/20 dark:bg-primary/20 flex items-center justify-center overflow-hidden">
                                        <Dog className="w-2.5 h-2.5 text-primary" />
                                    </div>
                                ))}
                            </div>
                            <span className="text-[10px] font-semibold text-foreground dark:text-stone-300">
                                Join <span className="text-primary">12,000+</span> dog lovers
                            </span>
                        </div>
                    </div>
                </div>
