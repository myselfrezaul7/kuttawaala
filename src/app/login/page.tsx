        ...
        <div className="min-h-screen bg-muted/30 dark:bg-zinc-950 flex flex-col justify-center items-center px-4">
            <div className="max-w-md w-full bg-white dark:bg-zinc-900 rounded-2xl shadow-xl p-8 border border-border/50 dark:border-zinc-800 text-center">
                ...
                <Button
                    ...
                    className="w-full h-12 text-lg bg-white dark:bg-zinc-800 hover:bg-muted/30 dark:hover:bg-zinc-700 text-foreground/90 dark:text-white border border-border dark:border-zinc-700 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                >
