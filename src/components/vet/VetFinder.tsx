...
export function VetFinder() {
    ...
    return (
        <div className="min-h-screen bg-muted/30 dark:bg-zinc-950 pb-20">
            {/* Hero Header */}
            <div className="bg-gradient-to-br from-primary via-orange-500 to-amber-600 text-white py-20 text-center px-4 relative overflow-hidden">
                <div className="relative z-10 container mx-auto">
                    ...
                    >
                        ...
                        <p className="text-orange-50 max-w-2xl mx-auto text-lg md:text-xl font-medium leading-relaxed">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-5 py-2.5 rounded-full shadow-lg">
                            <Stethoscope className="w-5 h-5 text-orange-200" />
                ...
                <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-amber-800/20 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/2" />
            </div>
            ...
            <div className="container mx-auto px-4 -mt-10 relative z-20">
                ...
                >
                    ...
                    <div className="relative group">
                        <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-muted-foreground/80 w-5 h-5 group-focus-within:text-primary transition-colors" />
                        <input
                            type="text"
                            placeholder="Search by clinic name, area, or service..."
                            className="w-full pl-14 pr-12 py-4 rounded-2xl border-2 border-transparent bg-muted/50 dark:bg-zinc-800/50 focus:bg-white dark:focus:bg-zinc-900 focus:border-primary/50 focus:ring-4 focus:ring-primary/10 outline-none transition-all text-lg shadow-inner"
                            value={searchQuery}
                        ...
                        <div className="w-full lg:w-1/4 space-y-2">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full appearance-none p-3 pl-4 pr-10 rounded-xl border border-border dark:border-zinc-700 bg-white dark:bg-zinc-900 focus:ring-2 focus:ring-primary outline-none transition-all cursor-pointer hover:border-primary/50"
                                >
                            ...
                            <div className="flex flex-wrap gap-2">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 border ${selectedService === "all"
                                        ...
                                        : "bg-white dark:bg-zinc-900 border-border dark:border-zinc-700 text-muted-foreground hover:border-primary hover:text-primary"
                                        }`}
                                >
                                    All Services
                                </button>
                ...
                {!loading && filteredVets.length === 0 && (
                    ...
                    >
                        ...
                        <Button onClick={resetFilters} size="lg" className="bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20 rounded-xl">
