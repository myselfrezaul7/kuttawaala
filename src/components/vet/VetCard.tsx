            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex flex-wrap gap-1.5 mb-6">
                    {(vet.services || []).slice(0, 3).map(service => (
                        <span
                            key={service}
                            className="text-xs px-2 py-1 bg-secondary/10 dark:bg-zinc-800 text-secondary-foreground/80 dark:text-zinc-400 rounded-md border border-secondary/20 dark:border-zinc-700"
                        >
                            {service}
                        </span>
                    ))}
